...
public class Home extends JFrame implements ActionListener {
    ...
    public Home() {
        ...
        menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(255, 255, 255)));
        menuBar.setBackground(new Color(80, 0, 109));
        ...
        mntmExit.setForeground(Color.darkGray);
        ...
        l1.setForeground(new Color(212, 126, 173));
        ...
        l4 = new JLabel(i9);
        l4.setBounds(630, 140, 225, 152);
        contentPane.add(l4);

        b1 = new JButton("Add Books");
        b1.addActionListener(this);
        b1.setBackground(new Color(80, 0, 109));
        ...
        b2.setBackground(new Color(80, 0, 109));
        ...
        b3.setBackground(new Color(80, 0, 109));
        ...
        panel.setBounds(100, 120, 800, 260);
        panel.setBackground(Color.WHITE);
        contentPane.add(panel);

        b4 = new JButton("Issue Book");
        b4.addActionListener(this);
        b4.setBackground(new Color(80, 0, 109));
        ...
        b5.setBackground(new Color(80, 0, 109));
        ...
        b6.setBackground(new Color(80, 0, 109));
        ...
        l6 = new JLabel(i15);
        l6.setBounds(432, 440, 139, 152);
        contentPane.add(l6);

        JLabel l7 = new JLabel("");
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/exit.png"));
        ...
        panel2.setBounds(100, 420, 800, 270);
