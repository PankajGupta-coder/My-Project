...
public class BookDetails extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			...
			conn con = new conn();
			if (ae.getSource() == b1) {
				// System.out.println("hello i am not just a thing to handle in soem case you
				// ");
			...
			if (text.equals("Delete")) {
				//System.out.println("JUst ru bro why you are taking so much time to handle in some case ");
